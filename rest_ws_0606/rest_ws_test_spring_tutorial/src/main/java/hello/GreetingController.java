...
public class GreetingController {
    ...
    public String createGroup(
    	...
    	int successCreation = Services.sendSQLData(
    			...
    			+ "duree_parcours_minutes, date, horaire, nombre_membres_max, url "
    			+ "id_lieu_rencontre) "
    			+ "VALUES ('"+userID+"','"+dureeHr+"','"+dureeMn+"','"
    					+date+"','"+horaire+"','"+nbMembresMax+"','"+url+"','"+ptRencontre+"')"
    			,true,true);
    ...
    //@RequestMapping(value="/subscribe_general", method = RequestMethod.GET)
    ...
    public String inscriptionGroup(
    	...
    	int successInscription = Services.sendSQLData(
    					
    			"INSERT INTO Membres_Groupes_A_Approuver "
    			+"(user_id, group_id) "
    			+ "VALUES ('"+userID+"','"+group_id+"')"
    			,true,true);
    	
        	
    	return "[{\"inscription_success\":\""+successInscription+"\"}]";
