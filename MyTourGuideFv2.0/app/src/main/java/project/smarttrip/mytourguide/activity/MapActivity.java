...
public class MapActivity extends ListActivity implements OnMapReadyCallback/*, LocationListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(data.hasExtra(TAG_PACKAGE+EXTRA_DESCRIPTION) && data.hasExtra(TAG_PACKAGE+EXTRA_LONG) &&
                ...
                Toast.makeText(getApplicationContext(), "Theme activity has list extra! ", Toast.LENGTH_LONG).show();
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int position, long id) {
                ...
                Toast.makeText(getApplicationContext(), "Long click on place "+id+" ", Toast.LENGTH_LONG).show();
