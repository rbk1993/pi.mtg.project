...
public class SignUpActivity extends Activity {
    ...
    private ImageView img_check_e;
    private ImageView img_check_p;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passwordCField.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                if (s.equals( ( (EditText) findViewById(R.id.password) ).getText().toString())) {
                    findViewById(R.id.image_check_p).setVisibility(View.VISIBLE);
                } else {
                    findViewById(R.id.image_check_p).setVisibility(View.GONE);
                }
            }
        });

        mailCField.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
            @Override
            ...
            @Override
            public void afterTextChanged(Editable s) {
                if(s.equals(((EditText) findViewById(R.id.email)).getText().toString())) {
                    findViewById(R.id.image_check_e).setVisibility(View.VISIBLE);
                } else {
                    findViewById(R.id.image_check_e).setVisibility(View.GONE);
                }
            }
        });
