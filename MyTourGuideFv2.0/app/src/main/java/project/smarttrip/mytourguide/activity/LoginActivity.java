        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.isEmpty() || password.isEmpty()) {
                    ...
                    intent.putExtra("nom", "admin mode"); intent.putExtra("prenom", "admin mode"); intent.putExtra(EXTRA_EXTRA_UID,"10099");
    ...
    private class WSRequest extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    user_id = String.valueOf(identity_obj.getInt("user_id"));
        ...
        protected void onPostExecute(Void result) {
            ...
            if(authenticationSuccess != 0) {
                ...
                Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                intent.putExtra("nom", nom); intent.putExtra("prenom", prenom); intent.putExtra(EXTRA_EXTRA_UID,user_id);
                startActivity(intent);
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
            } else {
