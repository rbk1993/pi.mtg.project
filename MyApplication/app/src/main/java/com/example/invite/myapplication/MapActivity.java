...
/*
        listTitle = data.getStringArrayListExtra("description");
        listLongitudes = data.getStringArrayListExtra("longitude");
        listLatitudes = data.getStringArrayListExtra("latitude");
        listOfId = data.getStringArrayListExtra("id");
*/
    ...
    public void onBackPressed() {
        Intent a = new Intent(MapActivity.this, MainPageActivity.class);

        a.putStringArrayListExtra("longitude",listLongitudes); //list of longitudes of places selected
        a.putStringArrayListExtra("latitude",listLatitudes); //list of latitudes of places selected
        a.putStringArrayListExtra("description", listTitle); //list of descriptions of places selected
        a.putStringArrayListExtra("id", listOfId); //list of id of places selected
    ...
    public void onMapReady(GoogleMap map) {
        ...
        map.moveCamera(CameraUpdateFactory.newLatLngZoom(myPosition, 6));
