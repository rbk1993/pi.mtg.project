...
public class SignUpActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(/*prenom.isEmpty() || nom.isEmpty() || mail.isEmpty() || password.isEmpty() || phone.isEmpty() || */login.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Please fill all required fields", Toast.LENGTH_LONG).show();
                }
                else if (!mail.equals(mailC)){
    ...
    private class WSRequest extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if(inscSuccess != 0) {
                Toast.makeText(getApplicationContext(), "You are registered ! Redireting ...", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(SignUpActivity.this, LoginActivity.class/*MainPageActivity.class*/);
                startActivity(intent);
            } else {
                Toast.makeText(getApplicationContext(), "Failed to register you, try again !", Toast.LENGTH_LONG).show();
            }
