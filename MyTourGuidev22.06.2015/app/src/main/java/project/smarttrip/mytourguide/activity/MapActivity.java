...
public class MapActivity extends ListActivity implements OnMapReadyCallback/*, LocationListener*/ {
    ...
    private static final LatLng lyPosition = new LatLng(45.753164,4.853731);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UID = data.getStringExtra(EXTRA_EXTRA_UID);
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int position, long id) {
                ...
                if (markerList.containsKey(id_lieu)) {
                    ...
                    Toast.makeText(getApplicationContext(), "Place is not already selected", Toast.LENGTH_LONG).show();
                }
                return true;
            }
        });
        ...
        button_creer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (parcours_ready == true){
                    ...
                    intent.putStringArrayListExtra("places_id",listOfId);
                    intent.putExtra(EXTRA_EXTRA_UID,UID);
                ...
                if (markerList.size() >= 3) {
                    ...
                    if(markerList.size() <=10) {
                        ...
                        String format_duree_trajet = String.format("%d heures, %d minutes",
                                TimeUnit.SECONDS.toHours(Integer.parseInt(value_duration)),
                                TimeUnit.SECONDS.toMinutes(Integer.parseInt(value_duration)) -
                                        TimeUnit.HOURS.toMinutes(TimeUnit.SECONDS.toHours(Integer.parseInt(value_duration)))
                        );
                        Toast.makeText(MapActivity.this, "votre trajet dure "+format_duree_trajet, Toast.LENGTH_SHORT).show();
                        */
                    } else {
                        Toast.makeText(getApplicationContext(), "Limite Google API version Gratuite (10 lieux) : veuillez sélectionner moins de lieux", Toast.LENGTH_LONG).show();
                    }
    ...
    public void onMapReady(GoogleMap map) {
        ...
        LatLng lyPosition = new LatLng(45.753164,4.853731);
...
/*
        if(!markerList.isEmpty()) {
            ...
            for (   String keys : markerList.keySet()  ) {
                bounds.include(markerList.get(keys).getPosition());
            }
            map.animateCamera(CameraUpdateFactory.newLatLngBounds(bounds.build(), 50), new GoogleMap.CancelableCallback() {
                @Override
            ...
            map.moveCamera(CameraUpdateFactory.newLatLngZoom(lyPosition,10));
        //}
    ...
    private String getMapsApiDirectionsUrl() {
        ...
        for (String id_lieu : markerList.keySet()) {
            ...
            if( !(markerList.firstEntry().getKey().equals(id_lieu)) && !(markerList.lastEntry().getKey().equals(id_lieu)) ) {
        ...
        String output = "json";
        String key = "key="+"AIzaSyDoP4aHve8wYZyeR18G1NMr6KWOhS3dXRo";
...
*/
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if(!markerList.containsKey(id_lieu)){
            ...
            //map.moveCamera(CameraUpdateFactory.newLatLngZoom(placePosition,13));

            CameraPosition newPlace =
                    new CameraPosition.Builder().target(placePosition)
                            .zoom(12)
                            .bearing(0)
                            .tilt(10)
                            .build();

            map.animateCamera(CameraUpdateFactory.newCameraPosition(newPlace), new GoogleMap.CancelableCallback() {
                @Override
                public void onFinish() {
                }
            ...
            Toast.makeText(getApplicationContext(), "Place successfully added to map ! ", Toast.LENGTH_LONG).show();
        } else {
